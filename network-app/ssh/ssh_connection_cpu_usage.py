...
# Prompting user for input - USER/PASSWORD FILE
user_file = input("\n# Enter user file path and name (e.g.: /home/user/Documents/myfile.txt): ")
...
cmd_file = input("\n# Enter commands file path and name (e.g.: /home/user/Documents/myfile.txt): ")
...
def ssh_connection(ip):
    ...
    try:
        ...
        # For testing purposes, this allows auto-accepting unknown hose keys
        ...
        # Extracting the second group, which matches the actual value of the CPU utilization and decoding the bytes to produce a string (encoded to the popular UTF-8 format)
        utilization = cpu.group(2).decode("utf-8")
        # Printing the CPU utilization value to the screen
        # print(utilization)

        # Opening the CPU utilization value to the screen
        with open("/home/rssarto/projects/python/python-network-programming-course/network-app/resources/cpu_usage_result.txt", "a") as f:
