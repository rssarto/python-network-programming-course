...
def animation_function(i):
    # Opening the file and reading each row of CPU utilization data in the file; creating a
    cpu_data = open(
        "/home/rssarto/projects/python/python-network-programming-course/network-app/resources/cpu_usage_result.txt").readlines()

    # Creating an empty list in which to append each value in the file converted from string
    x = []
...
# Using the figure, the function and a polling interval of 10000ms (10 seconds) to build the graph
